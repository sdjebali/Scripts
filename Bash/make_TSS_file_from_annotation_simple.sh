...
# This script supposes that the annotation file contains the gene name of exon features is in $10 and 
# the tr name is in $12
...
awk '(($3=="exon")&&(($7=="+")||($7=="-")))' $annotation | awk -v fldno=12 -f $EXTRACT5p > $annotbase\_exons_most5p.gff
echo done >&2
