...

{
    ...
    print b[1], "GENE-SWitCH Chicken transcriptome and gene expression atlas (smallRNA-seq)", "PROCESSED_READS", "RNA sequencing", studyid[run], sampleid[run], "", expid[run], "", run, "", "", "srnaseq/bamfiles/"a[n], "bam", "MD5", $2, "INRAE Centre Toulouse Occitanie", "2021-11-29", "YYYY-MM-DD";
}
