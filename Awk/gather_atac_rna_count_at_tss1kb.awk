...
# time awk -v dir=Aux -v fileRef1=$metatac -v fileRef2=$atac -v fileRef3=$metarna -v fileRef4=$rna -v fileRef5=an.tiss.common.atac.rna.tsv -f gather_atac_rna_count_at_tss1kb.awk $corr
# real	0m11.646s

# fileRef1 = header of the atacseq peak count file
...
# ...
# 120915 (11 fields)  *** 7th column indicate the gene list, usually one but could be two
...
# the genes at the tss +-1kb but this one is at position 7
# for each atac-seq peak that overlaps the tss +-1kb of a gene, writes a file with for each experiment
